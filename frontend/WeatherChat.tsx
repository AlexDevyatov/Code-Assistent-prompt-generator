  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      role: 'assistant',
      content: 'Привет! Я помогу тебе узнать о погоде. Спроси меня о текущей погоде или прогнозе в любом городе! 🌤️',
    },
  ])
      ...
      <div className="input-panel">
        <form onSubmit={handleSubmit} className="input-form">
          <textarea
            ...
            placeholder="Спроси о погоде... (Ctrl+Enter для отправки)"
            rows={1}
            disabled={isLoading}
